...
class Photos extends Model {
    ...
    //////////////////////////////////////////////
    function addPhoto($title_ar, $descs_ar, $title_en, $descs_en, $tags, $status, $user_id) {
        $this->title_ar = $title_ar;
        $this->descs_ar = $descs_ar;
        $this->title_en = $title_en;
        $this->descs_en = $descs_en;
        $this->tags = $tags;
        $this->status = $status;
    ...
    //////////////////////////////////////////////
    function updatePhoto($obj, $title_ar, $descs_ar, $title_en, $descs_en, $tags, $status) {
        $obj->title_ar = $title_ar;
        $obj->descs_ar = $descs_ar;
