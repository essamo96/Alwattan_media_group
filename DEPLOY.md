...
**الحالة الحالية (2026-08-01):** ملف الورشة أُعيد يدوياً إلى نسخة **FTP**
القديمة (بطلب صريح من المستخدم، رغم إثبات أن منفذ FTP 21 محجوب من عناوين
GitHub Actions بخطأ `ETIMEDOUT` — راجع قسم "قرارات تصميم" أسفله). إن فشل
النشر بنفس الخطأ، الحل الجاهز موجود في تاريخ git بالكامل: نسخة SSH التي
اجتازت اختبار الاتصال فعلاً، بالـcommit `4da53d1`.
