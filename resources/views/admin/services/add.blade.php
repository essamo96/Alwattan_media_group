...
<ul class="page-breadcrumb">
    ...
    <li>
        <a href="{{ route('services.view') }}">ادارة الخدمات </a>
        <i class="fa fa-angle-right"></i>
    </li>
    <li>
        <a href="{{ route('services.add') }}">إضافة خدمة</a>
    </li>
</ul>
@stop
@section('page-title')
<h1 class="page-title"> ادارة الخدمات
    <small>إضافة خدمة</small>
</h1>
@stop
...
<div class="portlet box {{ $form_class }}">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-grid"></i>إضافة خدمة</div>
    </div>
                        ...
                        <div class="tab-pane active" id="tab_0">
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" value="{{ old('image') }}" name="image" id="image" class="form-control" placeholder="ايقونة الخدمة">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
