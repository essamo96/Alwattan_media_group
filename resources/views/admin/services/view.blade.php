...
<div class="card">
    <div class="card-header border-0 pt-6">
        <div class="card-title">
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <input type="text" name="title" id="name" class="form-control form-control-solid w-250px ps-12 searchable" placeholder="بحث بالعنوان">
            </div>
        </div>
    ...
    <div class="card-body pt-0">
        ...
        <table class="table align-middle table-row-dashed table-hover fs-6 gy-5" id="services_table">
            <thead>
    ...
    $(document).ready(function () {
        ...
        var oTable = $('#services_table').DataTable({
            ...
            "columns": [
                ...
                {"data": "title", "title": "الخدمة", "orderable": true, "searchable": false},
