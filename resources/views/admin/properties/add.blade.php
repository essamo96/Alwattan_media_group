...
<ul class="page-breadcrumb">
    ...
    <li>
        <a href="{{ route('properties.add') }}">Ø¥Ø¶Ø§ÙØ© Ø¹Ù‚Ø§Ø±</a>
    </li>
</ul>
@stop
@section('page-title')
<h1 class="page-title"> Ø§Ø¯Ø§Ø±Ø© Ø§Ù„Ø¹Ù‚Ø§Ø±Ø§Øª
    <small>Ø¥Ø¶Ø§ÙØ© Ø¹Ù‚Ø§Ø±</small>
</h1>
@stop
...
<div class="portlet box {{ $form_class }}">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-grid"></i>Ø¥Ø¶Ø§ÙØ© Ø¹Ù‚Ø§Ø±</div>
    </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_0">
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" value="{{old('price')}}" name="price" class="form-control" placeholder="Ø§Ù„Ø³Ø¹Ø±">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3">Ø§Ù„Ù…Ø³Ø§Ø­Ø©</label>
                                    <div class="col-md-6">
                                        <input type="text" value="{{old('area')}}" name="area" class="form-control" placeholder="Ø§Ù„Ù…Ø³Ø§Ø­Ø©">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3">Ø¹Ø¯Ø¯ Ø§Ù„Ø­Ù…Ø§Ù…Ø§Øª</label>
                                    <div class="col-md-6">
                                        <input type="text" value="{{old('bathroom')}}" name="bathroom" class="form-control" placeholder="Ø¹Ø¯Ø¯ Ø§Ù„Ø­Ù…Ø§Ù…Ø§Øª">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3">Ø¹Ø¯Ø¯ Ø§Ù„ØºØ±Ù</label>
                                    <div class="col-md-6">
                                        <input type="text" value="{{old('bedroom')}}" name="bedroom" class="form-control" placeholder="Ø¹Ø¯Ø¯ Ø§Ù„ØºØ±Ù">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3">Ø§Ù„Ø¹Ø§Ø¦Ø¯ Ø§Ù„Ø³Ù†ÙˆÙŠ</label>
                                    <div class="col-md-6">
                                        <input type="text" value="{{old('annual_return')}}" name="annual_return" class="form-control" placeholder="Ø§Ù„Ø¹Ø§Ø¦Ø¯ Ø§Ù„Ø³Ù†ÙˆÙŠ">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="checkbox" value="1" name="is_new" class="make-switch" data-on-text="&nbsp;ØªÙØ¹ÙŠÙ„&nbsp;" data-off-text="&nbsp;ØªØ¹Ø·ÙŠÙ„&nbsp;" {{ old('is_new') == 1 ? 'checked' : '' }}>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3">Ø§Ù„Ø­Ø§Ù„Ø©</label>
                                    <div class="col-md-6">
                                        <input type="checkbox" value="1" name="status" class="make-switch" data-on-text="&nbsp;ØªÙØ¹ÙŠÙ„&nbsp;" data-off-text="&nbsp;ØªØ¹Ø·ÙŠÙ„&nbsp;" {{ old('status') == 1 ? 'checked' : '' }}>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane" id="tab_{{ $loop->iteration }}">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" value="{{old($item->prefix.'_title')}}" name="{{$item->prefix}}_title" class="form-control" placeholder="Ø§Ù„Ø¹Ù†ÙˆØ§Ù†">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3">Ø§Ù„ØªÙØ§ØµÙŠÙ„</label>
                                <div class="col-md-6">
                                    <textarea name="{{$item->prefix}}_details"  class="form-control ckeditor" rows="3">{{old($item->prefix.'_details')}}</textarea>
                                </div>
                            </div>
                        </div>
                        @endforeach
