...
<div class="card">
    <div class="card-header">
        <div class="card-title">تعديل عقار</div>
    </div>
    <div class="card-body">
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="tab_0">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6">
                            <input type="text" value="{{ $info->price }}" name="price" class="form-control" placeholder="السعر">
                        </div>
                    </div>
                    <div class="row mb-5">
                        <label class="col-md-3 col-form-label">المساحة</label>
                        <div class="col-md-6">
                            <input type="text" value="{{ $info->area }}" name="area" class="form-control" placeholder="المساحة">
                        </div>
                    </div>
                    <div class="row mb-5">
                        <label class="col-md-3 col-form-label">عدد الحمامات</label>
                        <div class="col-md-6">
                            <input type="text" value="{{ $info->bathroom }}" name="bathroom" class="form-control" placeholder="عدد الحمامات">
                        </div>
                    </div>
                    <div class="row mb-5">
                        <label class="col-md-3 col-form-label">عدد الغرف</label>
                        <div class="col-md-6">
                            <input type="text" value="{{ $info->bedroom }}" name="bedroom" class="form-control" placeholder="عدد الغرف">
                        </div>
                    </div>
                    <div class="row mb-5">
                        <label class="col-md-3 col-form-label">العائد السنوي</label>
                        <div class="col-md-6">
                            <input type="text" value="{{ $info->annual_return }}" name="annual_return" class="form-control" placeholder="العائد السنوي">
                        </div>
                    </div>
                    <div class="row mb-5">
                        <div class="col-md-6">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6">
                            <div class="form-check form-switch form-check-custom form-check-solid">
                                <input class="form-check-input" type="checkbox" value="1" name="is_new" {{ $info->is_new == 1 ? 'checked' : '' }}>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-5">
                ...
                <div class="tab-pane fade" id="tab_{{ $loop->iteration }}">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6">
                            <textarea name="{{ $item->prefix }}_details" id="{{ $item->prefix }}_details" class="form-control ckeditor" data-lang="{{ $item->prefix }}" rows="3">{{ $info->translate($item->prefix) ? $info->translate($item->prefix)->details : '' }}</textarea>
                        </div>
                    </div>
                </div>
                @endforeach
