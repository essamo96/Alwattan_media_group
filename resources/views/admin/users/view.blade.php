...
<div class="card">
    ...
    <div class="card-body pt-0">
        ...
        <table class="table align-middle table-row-dashed table-hover fs-6 gy-5" id="users_table">
            <thead>
    ...
    $(document).ready(function () {
        ...
        var oTable = $('#users_table').DataTable({
            ...
            "columns": [
                ...
                {"data": "username", "title": "اسم المستخدم (User Name)", "orderable": true, "searchable": false},
                {"data": "name", "title": "الإسم الشخصي", "orderable": true, "searchable": false},
                {"data": "created_by", "title": "انشىء بواسطة", "orderable": true, "searchable": false},
