...
<li class="breadcrumb-item text-muted"><a href="{{ route('pages.view') }}" class="text-muted text-hover-primary">إدارة الصفحات الثابتة</a></li>
<li class="breadcrumb-item"><span class="bullet bg-gray-400 w-5px h-2px"></span></li>
...
<div class="card">
    <div class="card-header">
        <div class="card-title">تعديل صفحة ثابتة</div>
    </div>
    <div class="card-body">
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="tab_0">
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6">
                            <input type="text" value="{{ $info->slug }}" name="slug" class="form-control" placeholder="اسم مخصص لجوجل">
                        </div>
                    </div>
                    <div class="row mb-5">
                        <label class="col-md-3 col-form-label">الكلمات الدلالية</label>
                        <div class="col-md-6">
                            <input type="text" value="{{ $info->tags }}" name="tags" class="form-control" placeholder="الكلمات الدلالية">
                        </div>
                    </div>
                    <div class="row mb-5">
                        <label class="col-md-3 col-form-label">الصورة الأولى</label>
                        <div class="col-md-6">
                            <img src="{{ asset('uploads/image/'.$info->image) }}" alt="" class="img-thumbnail mb-2 d-block" style="max-width:200px;max-height:150px;">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6">
                            @if($info->image2)
                            <img src="{{ asset('uploads/image/'.$info->image2) }}" alt="" class="img-thumbnail mb-2 d-block" style="max-width:200px;max-height:150px;">
                            @endif
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6">
                            @if($info->image3)
                            <img src="{{ asset('uploads/image/'.$info->image3) }}" alt="" class="img-thumbnail mb-2 d-block" style="max-width:200px;max-height:150px;">
                            @endif
