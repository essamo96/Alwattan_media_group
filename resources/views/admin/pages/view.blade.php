...
<li class="breadcrumb-item text-muted">الصفحات الثابتة</li>
@endsection
...
<div class="card">
    <div class="card-header border-0 pt-6">
        <div class="card-title">
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <input type="text" name="title" id="title" class="form-control form-control-solid w-250px ps-12 searchable" placeholder="بحث بالإسم">
            </div>
        </div>
    ...
    <div class="card-body pt-0">
        ...
        <table class="table align-middle table-row-dashed table-hover fs-6 gy-5" id="pages_table">
            <thead>
