...
<li class="breadcrumb-item"><span class="bullet bg-gray-400 w-5px h-2px"></span></li>
<li class="breadcrumb-item text-muted">تعديل صورة</li>
@endsection

@section('content')
<div class="card">
    <div class="card-header">
        <div class="card-title">تعديل صورة</div>
    </div>
    <div class="card-body">
        ...
        <form role="form" method="post" action="" enctype="multipart/form-data">
            ...
            <div class="row mb-5">
                ...
                <div class="col-md-6">
                    <input type="text" value="{{ old('title', $info->title) }}" name="title" id="title" class="form-control" placeholder="العنوان">
                </div>
            </div>
            <div class="row mb-5">
                <label class="col-md-3 col-form-label">الصورة الحالية</label>
                <div class="col-md-6">
                    <img src="{{ asset('uploads/gallery/' . $info->image) }}" style="max-height:120px;border-radius:6px;" class="mb-3 d-block">
            ...
            <div class="row mb-5">
                ...
                <div class="col-md-6">
                    <input type="number" value="{{ old('sort_order', $info->sort_order) }}" name="sort_order" id="sort_order" class="form-control">
