...
<li class="breadcrumb-item text-muted">معرض الصور</li>
@endsection
...
<div class="card">
    <div class="card-header border-0 pt-6">
        ...
        @can('admin.gallery.add')
        <div class="card-toolbar">
            <a href="{{ route('gallery.add') }}" class="btn btn-primary">
                <i class="ki-duotone ki-plus fs-2"></i> إضافة صورة
            </a>
        </div>
        @endcan
    </div>
    <div class="card-body pt-0">
        ...
        <div class="text-muted fs-7 mb-3">هذه الصور تظهر بمعرض الصور بالموقع الخارجي، مرتّبة حسب رقم الترتيب (الأصغر يظهر أولاً).</div>
        <table class="table align-middle table-row-dashed table-hover fs-6 gy-5" id="gallery_table">
            <thead>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var oTable = $('#gallery_table').DataTable({
            "processing": true,
            "serverSide": true,
            "autoWidth": false,
            "language": {
            ...
            "columns": [
                ...
                {"data": "image", "title": "الصورة", "orderable": false, "searchable": false, "render": function (data) {
                    return data ? '<img src="{{ asset("uploads/gallery/") }}/' + data + '" style="max-height:45px;max-width:80px;object-fit:cover;border-radius:4px;">' : '';
                }},
