...
@section('page-breadcrumb')
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{ route('categories.view') }}">الأقسام</a>
            <i class="fa fa-angle-right"></i>
            </i>
        </li>
        <li>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet box {{ $form_class }}">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="icon-grid"></i>إدارة الأقسام</div>
                    @can('admin.categories.add')
                    <div class="actions">
                        <a href="{{ route('categories.add') }}" class="btn btn-default btn-sm">
