            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="tab_0">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6">
                            <input type="text" value="{{ $info->sort }}" name="sort" class="form-control" placeholder="الترتيب">
                        </div>
                    </div>
                    <div class="row mb-5">
                        <label class="col-md-3 col-form-label">عدد الأعمدة</label>
                        <div class="col-md-6">
                            <input type="text" value="{{ $info->col_no }}" name="col_no" class="form-control" placeholder="عدد الأعمدة">
                        </div>
                    </div>
                    <div class="row mb-5">
                        <label class="col-md-3 col-form-label">الكلمات الدلالية</label>
                        <div class="col-md-6">
                            <input type="text" value="{{ $info->tags }}" name="tags" id="tags" class="form-control" placeholder="الكلمات الدلالية">
                        </div>
                    </div>
                    <div class="row mb-5">
                        <label class="col-md-3 col-form-label">الرابط المخصص</label>
                        <div class="col-md-6">
                            <input type="text" value="{{ $info->slug }}" name="slug" class="form-control" placeholder="الرابط المخصص">
                        </div>
                    </div>
                    <div class="row mb-5">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6">
                            <div class="form-check form-switch form-check-custom form-check-solid">
                                <input class="form-check-input" type="checkbox" value="1" name="in_menu" {{ $info->in_menu == 1 ? 'checked' : '' }}>
                            </div>
                        </div>
                    </div>
                </div>
