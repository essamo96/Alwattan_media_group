...
<li class="breadcrumb-item"><span class="bullet bg-gray-400 w-5px h-2px"></span></li>
<li class="breadcrumb-item text-muted">تعديل جهة اتصال</li>
@endsection

@section('content')
<div class="card">
    <div class="card-header">
        <div class="card-title">تعديل جهة اتصال</div>
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="tab_0">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6">
                            <input type="text" value="{{ $info->another_mobile }}" name="another_mobile" class="form-control">
                        </div>
                    </div>
                    <div class="row mb-5">
                        <label class="col-md-3 col-form-label">الشخص المسؤول</label>
                        <div class="col-md-6">
                            <input type="text" value="{{ $info->master }}" name="master" class="form-control">
                        </div>
                    </div>
                    <div class="row mb-5">
                        <label class="col-md-3 col-form-label">الايميل</label>
                        <div class="col-md-6">
                            <input type="email" value="{{ $info->email }}" name="email" class="form-control" data-role="emailinput">
                        </div>
                    </div>
                    <div class="row mb-5">
                        <label class="col-md-3 col-form-label">تاريخ التنبيه</label>
                        <div class="col-md-6">
                            <input type="date" class="form-control" name="remember_date" value="{{ $info->remember_date }}">
                        </div>
                    </div>
                    <div class="row mb-5">
                        <label class="col-md-3 col-form-label">اضف ملاحظة</label>
                        <div class="col-md-9">
                            <textarea id="notes" class="form-control" rows="10" name="notes">{{ $info->notes }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
