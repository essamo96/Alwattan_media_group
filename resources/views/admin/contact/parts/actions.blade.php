<div class="d-flex">
    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
        ...
        <div class="menu-item px-3">
            <a href="{{ route('contact.edit', ['id' => rawurlencode(Crypt::encrypt($id))]) }}" class="menu-link px-3">
        ...
        <div class="menu-item px-3">
            <a href="{{ route('contact.info', ['id' => rawurlencode(Crypt::encrypt($id))]) }}" class="menu-link px-3">
        ...
        <div class="menu-item px-3">
            <a href="{{ url('admin/contact/print/'.rawurlencode(Crypt::encrypt($id))) }}" data-href="{{ Crypt::encrypt($id) }}" class="menu-link px-3 btnPrint">
