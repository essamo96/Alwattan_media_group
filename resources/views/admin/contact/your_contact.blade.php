...
@section('page-breadcrumb')
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{ route('contact.view') }}">ادارة جهات الاتصال : جهات اتصالك</a>
            <i class="fa fa-angle-right"></i>
            </i>
        </li>
        <li>
...
@section('page-title')
    <h1 class="page-title">جهات الاتصال
        <small>إدارة جهات الاتصال : جهات اتصالك</small>
    </h1>
@stop
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet box {{ $form_class }}">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="icon-grid"></i>إدارةجهات الاتصال : جهات اتصالك</div>
