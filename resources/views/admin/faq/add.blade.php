...
<li class="breadcrumb-item"><span class="bullet bg-gray-400 w-5px h-2px"></span></li>
<li class="breadcrumb-item text-muted">اضافة الاسئلة الشائعة</li>
@endsection

@section('content')
<div class="card">
    <div class="card-header">
        <div class="card-title">اضافة الاسئلة الشائعة</div>
    </div>
    <div class="card-body">
        ...
        <form role="form" method="post" action="" enctype="multipart/form-data">
            ...
            <div class="row mb-5">
                ...
                <div class="col-md-6">
                    <input type="text" value="{{ old('name_ar') }}" name="name_ar" id="name_ar" class="form-control" placeholder="السؤال عربي">
                </div>
            </div>
            <div class="row mb-5">
            ...
            <div class="row mb-5">
                ...
                <div class="col-md-6">
                    <input type="text" value="{{ old('name_en') }}" name="name_en" id="name_en" class="form-control" placeholder="السؤال انجليزي">
                </div>
            </div>
            <div class="row mb-5">
