...
<ul class="page-breadcrumb">
    ...
    <li>
        <a href="{{ route('sliders.edit',['id' => Crypt::encrypt($info->id)]) }}">تعديل الاسئلة الشائعة</a>
    </li>
</ul>
@stop
...
<div class="portlet box {{ $form_class }}">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-puzzle"></i>تعديل الاسئلة الشائعة </div>
    </div>
            ...
            <div class="form-body">
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" value="{{ $info->name_ar }}" name="name_ar" id="name_ar" class="form-control" placeholder="السطر الاول">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" value="{{ $info->name_en }}" name="name_en" class="form-control" placeholder="السطر الاول انجليزي">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">الجواب انجليزي</label>
                        <div class="col-md-6">
                            <textarea name="name1_en" class="form-control" placeholder="الجواب انجليزي انجليزي">{{ $info->name1_en }}</textarea>
                        </div>
                    </div>                   
                </div>
                <div class="form-group">
