    ...
    <div class="card-body">
        ...
        <form role="form" method="post" action="" enctype="multipart/form-data">
            ...
            <div class="row mb-5">
                ...
                <div class="col-md-6">
                    <textarea name="name1_ar" id="name1_ar" class="form-control ckeditor" data-lang="ar" placeholder="الجواب عربي" rows="3">{{ $info->name1_ar }}</textarea>
                </div>
            </div>
            <div class="row mb-5">
            ...
            <div class="row mb-5">
                ...
                <div class="col-md-6">
                    <textarea name="name1_en" id="name1_en" class="form-control ckeditor" data-lang="en" placeholder="الجواب انجليزي">{{ $info->name1_en }}</textarea>
                </div>
            </div>
            <div class="row mb-5">
