...
<li class="breadcrumb-item text-muted">الاسئلة الشائعة</li>
@endsection
...
<div class="card">
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-toolbar">
            <a href="{{ route('faq.add') }}" class="btn btn-primary">
                <i class="ki-duotone ki-plus fs-2"></i> اضافة الاسئلة الشائعة
            </a>
        </div>
        @endcan
    </div>
    <div class="card-body pt-0">
        ...
        <table class="table align-middle table-row-dashed table-hover fs-6 gy-5" id="faq_table">
            <thead>
