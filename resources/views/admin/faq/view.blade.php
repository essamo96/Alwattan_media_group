...
<ul class="page-breadcrumb">
    ...
    <li>
        <a href="{{ route('faq.view') }}">الاسئلة الشائعة</a>
        <i class="fa fa-circle"></i>
    </li>
    <li>
        <span>ادارة الاسئلة الشائعة</span>
    </li>
</ul>
@stop
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet box {{ $form_class }}">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-puzzle"></i>ادارة الاسئلة الشائعة</div>
                @can('admin.faq.add')
                <div class="actions">
                    <a href="{{ route('faq.add') }}" class="btn btn-default btn-sm">
                        <i class="fa fa-plus"></i> اضافة الاسئلة الشائعة </a>
                </div>
                @endcan
            </div>
            <div class="portlet-body">
