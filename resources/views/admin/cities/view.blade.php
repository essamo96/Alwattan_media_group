...
<ul class="page-breadcrumb">
    ...
    <li>
        <a href="{{ route('cities.view') }}">المدن</a>
        <i class="fa fa-circle"></i>
    </li>
    <li>
        <span>ادارة المدن</span>
    </li>
</ul>
@stop
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet box {{ $form_class }}">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-puzzle"></i>ادارة المدن</div>
                @can('admin.cities.add')
                <div class="actions">
                    <a href="{{ route('cities.add') }}" class="btn btn-default btn-sm">
            ...
            <div class="portlet-body">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="cities_table">
                    <thead>
                        <tr>
                            <th> # </th>
                            <th> الاسم </th>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var oTable = $('#cities_table').DataTable({
            "processing": true,
            "serverSide": true,
            "language": {
