...
<li class="breadcrumb-item text-muted">الإعلانات</li>
@endsection
...
<div class="card">
    <div class="card-header border-0 pt-6">
        <div class="card-title">
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <input type="text" name="name" id="name" class="form-control form-control-solid w-250px ps-12 searchable" placeholder="بحث بالإسم">
            </div>
        </div>
        @can('admin.advertisements.add')
        <div class="card-toolbar">
            <a href="{{ route('advertisements.add') }}" class="btn btn-primary">
    ...
    <div class="card-body pt-0">
        ...
        <table class="table align-middle table-row-dashed table-hover fs-6 gy-5" id="advertisements_table">
            <thead>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var oTable = $('#advertisements_table').DataTable({
            "processing": true,
            "serverSide": true,
            "autoWidth": false,
            "language": {
            ...
            "columns": [
                ...
                {"data": "image", "title": "الصورة", "orderable": false, "searchable": false, "render": function (data) {
                    return data ? '<img src="{{ asset("uploads/advertisements/") }}/' + data + '" style="max-height:45px;max-width:80px;object-fit:cover;border-radius:4px;">' : '';
                }},
                {"data": "name", "title": "الإسم", "orderable": true, "searchable": false},
                {"data": "type", "title": "النوع", "orderable": false, "searchable": false, "render": function (data) {
                    return data == 1 ? 'بانر رئيسي' : (data == 2 ? 'إعلان جانبي' : '');
                }},
                {"data": "expiry_date", "title": "تاريخ الانتهاء", "orderable": true, "searchable": false},
