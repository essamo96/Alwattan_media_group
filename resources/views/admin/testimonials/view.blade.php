...
<ul class="page-breadcrumb">
    ...
    <li>
        <span>عرض قالوا عنا</span>
    </li>
</ul>
@stop

@section('page-title')
<h1 class="page-title">قالوا عنا
    <small>قالوا عنا</small>
</h1>
@stop
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet box {{ $form_class }}">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-grid"></i>قالوا عنا</div>
                @can('admin.testimonials.add')
                <div class="actions">
                    <a href="{{ route('testimonials.add') }}" class="btn btn-default btn-sm">
