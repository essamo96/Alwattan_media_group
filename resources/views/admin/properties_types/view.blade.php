...
<ul class="page-breadcrumb">
    ...
    <li>
        <a href="{{ route('properties_types.view') }}">انواع العقارات</a>
        <i class="fa fa-circle"></i>
    </li>
    <li>
        <span>ادارة انواع العقارات</span>
    </li>
</ul>
@stop
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet box {{ $form_class }}">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-puzzle"></i>ادارة انواع العقارات</div>
                @can('admin.properties_types.add')
                <div class="actions">
                    <a href="{{ route('properties_types.add') }}" class="btn btn-default btn-sm">
                        <i class="fa fa-plus"></i> اضافة نوع </a>
                </div>
                @endcan
            </div>
            <div class="portlet-body">
                @include('admin.layout.error')
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="properties_types_table">
                    <thead>
                        <tr>
                            <th> # </th>
                            <th> الاسم </th>
