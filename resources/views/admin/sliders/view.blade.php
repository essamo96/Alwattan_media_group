...
<ul class="page-breadcrumb">
    ...
    <li>
        <a href="{{ route('sliders.view') }}">السلايدات</a>
        <i class="fa fa-circle"></i>
    </li>
    <li>
        <span>ادارة السلايدات</span>
    </li>
</ul>
@stop
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet box {{ $form_class }}">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-puzzle"></i>ادارة السلايدات</div>
                @can('admin.sliders.add')
                <div class="actions">
                    <a href="{{ route('sliders.add') }}" class="btn btn-default btn-sm">
                        <i class="fa fa-plus"></i> اضافة سلايد </a>
                </div>
                @endcan
            </div>
            <div class="portlet-body">
                @include('admin.layout.error')
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sliders_table">
                    <thead>
                        <tr>
                            <th> # </th>
                            <th> الاسم </th>
