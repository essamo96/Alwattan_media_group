...
<li class="breadcrumb-item text-muted">السلايدات</li>
@endsection
...
<div class="card">
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-toolbar">
            <a href="{{ route('sliders.add') }}" class="btn btn-primary">
                <i class="ki-duotone ki-plus fs-2"></i> اضافة سلايد
            </a>
        </div>
        @endcan
    </div>
    <div class="card-body pt-0">
        ...
        <table class="table align-middle table-row-dashed table-hover fs-6 gy-5" id="sliders_table">
            <thead>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var oTable = $('#sliders_table').DataTable({
            "processing": true,
            "serverSide": true,
            "autoWidth": false,
            "language": {
        ...
        $(document).on('click', ".status", function () {
            ...
            $.ajax({
                ...
                if (data.type == 'yes') {
                    ...
                    item.html('<i class="ki-duotone ki-check fs-6 me-1"></i> مفعل');
                } else if (data.type == 'no') {
                    item.removeClass("badge-light-success").addClass("badge-light-danger");
                    item.html('<i class="ki-duotone ki-cross fs-6 me-1"></i> معطل');
                }
