        ...
        <div class="tg-aboutus">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 p-0">
                <div class="text-center" style="">
                    <img src="{{ url('uploads/image/'.$abed->image) }}" class=" left-round-border" alt=" {{ $abed->title }}">
                </div>
                <div class="about-right-section">
                    <span class="about-quote" style="right: 3rem;top: 5px;">
                        &#8221;
                    </span>
                    {!!$abed->details!!}
                    <span class="about-quote" style="left: 3rem;bottom: 0px;">
                        &#8220;
                    </span>
                </div>
                <div style="text-align: left; color: #20A7DF;margin-bottom: 2rem;">
                    {{ $abed->title }}
                </div>
